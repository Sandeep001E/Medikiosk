...
export default function ReportedProblemSummaryModal({
  ...
  const { currentUser: authUser, updateActiveReportedProblem } = useAuth();
        ...
        <div className="no-print bg-slate-50 border-b border-slate-200 p-4 shrink-0">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center space-x-1.5 px-4 py-2.5 rounded-xl bg-[#2B4A8A] hover:bg-[#223B6E] text-white text-xs font-extrabold shadow-sm transition-all shrink-0 active:scale-95 disabled:opacity-50"
            >
              ...
              <div className="rounded-2xl border-2 border-amber-300 bg-amber-50/50 p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  <div className="bg-white p-3 rounded-xl border border-amber-200 shadow-2xs">
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">{summaryData.ayurvedaDashavidhaProfile.agniAharaShakti?.appetiteStatus || 'Normal appetite'}</p>
                  </div>
                  ...
                  <div className="bg-white p-3 rounded-xl border border-amber-200 shadow-2xs">
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">{summaryData.ayurvedaDashavidhaProfile.koshtaElimination?.bowelRegularity || 'Regular bowels'}</p>
                  </div>
                  ...
                  <div className="bg-white p-3 rounded-xl border border-amber-200 shadow-2xs">
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">{summaryData.ayurvedaDashavidhaProfile.sattvaNidra?.mentalResilience || 'Madhyama Sattva'}</p>
                  </div>

                  <div className="bg-white p-3 rounded-xl border border-amber-200 shadow-2xs">
                    <span className="text-[10px] font-black uppercase tracking-wider text-amber-800 block">Prakriti / Vikriti Tendency</span>
                    <p className="text-xs font-black text-slate-900 mt-1">{summaryData.ayurvedaDashavidhaProfile.prakritiVikriti?.doshaImbalanceTendency || 'Pitta-Kapha'}</p>
                    <p className="text-[10px] text-slate-500 mt-0.5">{summaryData.ayurvedaDashavidhaProfile.prakritiVikriti?.thermalReaction || 'Moderate heat/cold tolerance'}</p>
                  </div>
                  ...
                  <div className="bg-white p-3 rounded-xl border border-amber-200 shadow-2xs">
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">{summaryData.ayurvedaDashavidhaProfile.vyayamaShakti?.fatigueOnset || 'Normal endurance'}</p>
                  </div>
                </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
              <div className="flex items-center justify-between mb-3 border-b border-slate-200 pb-2">
                ...
                <span className="text-[10px] font-bold text-slate-500">
                  {summaryData?.relatedPrescriptions?.length || 0} Prescriptions
                </span>
              </div>
