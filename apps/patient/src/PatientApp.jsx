...
function PatientLayout() {
  ...
  const { isConnected } = useLiveSync(sseUrl, (data) => {
    ...
    if (data.event === 'PRESCRIPTION_ADDED') {
      ...
      window.dispatchEvent(
        new CustomEvent('patient-data-refresh', {
          detail: data
        })
      );
      ...
      setLiveNotification({
        ...
        message:
          data.payload?.report?.title ||
          'Your clinical document has been digitized.',
        type: 'report',
        timestamp: new Date().toLocaleTimeString()
      });
  ...
  const handleOpenReportedProblem = () => {
    ...
    setTimeout(() => {
      window.dispatchEvent(
        new CustomEvent('open-reported-problem-modal')
      );
    }, 50);
  };
  ...
  const navItems = [
    ...
    {
      to: '/problem-history',
      label: t('problemHistory', 'Problem History'),
      icon: Clock
    },
    {
      to: '/prescriptions',
    ...
    {
      to: '/reports',
      label: t('reportsOcr', 'Reports & OCR'),
      icon: FileText
    },
    {
      to: '/profile',
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col">
        ...
        <div className="fixed top-20 right-6 z-50 max-w-md w-full animate-bounce-short">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white p-4 rounded-2xl shadow-2xl border-2 border-emerald-300/40 flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-emerald-50 mt-1 leading-snug">
      ...
      <header className="h-[76px] bg-white border-b border-slate-200/90 sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 shadow-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            >
              ...
              <div className="text-left leading-tight max-w-[170px]">
                ...
                <span className="text-[10px] text-slate-500 font-mono">
                  {activeReportedProblem
                    ? `Day ${getProblemDaysActive(
                      activeReportedProblem.timestamp
                    )} of 3 active`
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 rounded-xl text-xs font-bold text-[#B84B16] hover:text-white bg-[#B84B16]/10 hover:bg-[#B84B16] border border-[#B84B16]/30 hover:border-[#B84B16] transition-all shadow-xs"
      ...
      {/* ===================================================== */}
      {/* TOP NAVIGATION / ROUTING BAR - #B84B16 */}
      {/* ===================================================== */}

      <nav className="bg-[#B84B16] text-white w-full shadow-md hidden md:block">

        <div className="px-4 sm:px-6 flex items-center space-x-1 h-[44px]">
          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                key={item.to}
                to={item.to}
                className={`flex items-center space-x-2 px-4 h-full text-sm font-semibold transition-colors border-b-2 ${isActive
            ...
            <div className="w-[280px] bg-white h-full p-5 flex flex-col justify-between shadow-2xl">
              ...
              <div>
                ...
                <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-4">
                  ...
                  <span className="font-bold text-[#2B4A8A] text-sm">
                    Patient Menu
                  </span>
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <NavLink
                        ...
                        className={`flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-bold ${isActive
                            ? 'bg-[#B84B16] text-white'
        ...
        <main className="flex-1 min-w-0 p-4 sm:p-6 lg:p-8">
          ...
          <Routes>
            ...
            <Route
              ...
              element={<ReportedProblemHistory />}
            />
