...
export default function Profile() {
  const { currentUser, updatePatientProfile, t } = useAuth();
          ...
          <div>
            <div className="flex items-center justify-center sm:justify-start space-x-2">
              <h1 className="text-2xl font-bold tracking-tight">
                {currentUser?.fullName || t('profile', 'Patient Profile')}
              </h1>
      ...
      <form onSubmit={handleSaveProfile} className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-100 space-y-6">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <h2 className="text-lg font-bold text-slate-900 flex items-center space-x-2">
            ...
            <span>{t('patientInformation', 'Patient Information & Health Profile')}</span>
          </h2>
        </div>
